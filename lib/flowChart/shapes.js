var StateShape = (
    function () {
        ...
        shape.process = (shapeName, stateStructure, config = defaultConfig) => {
        ...
        shape.decision = (shapeName, stateStructure, config = defaultConfig) => {
            const width = config.shapeWidth
            const height = config.shapeHeight
        ...
        shape.external = (shapeName, stateStructure, config = defaultConfig) => {
            const width = config.shapeWidth
            const height = config.shapeHeight
        ...
        shape.enter = shape.end = (shapeName, stateStructure, config = defaultConfig) => {
         ...
         */
        function StateShape(shapeName, stateStructure, config = defaultConfig) {
            ...
            this.render = () => {
                ...
                const struct = (shape[stateStructure.type])(shapeName, stateStructure, conf)
